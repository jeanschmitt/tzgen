...
func TestUnmarshalPrim(t *testing.T) {
	cases := map[string]struct {
		...
		"string ptr":       {prim: micheline.NewString("hello"), dst: (*string)(nil), want: toPtr("hello")},
		"bigInt ptr":       {prim: micheline.NewInt64(42), dst: (**big.Int)(nil), want: toPtr(big.NewInt(42))},
		"string slice":     {prim: micheline.NewSeq(micheline.NewString("1"), micheline.NewString("2")), dst: []string{}, want: []string{"1", "2"}},
		"string ptr slice": {prim: micheline.NewSeq(micheline.NewString("1"), micheline.NewString("2")), dst: []*string{}, want: []*string{toPtr("1"), toPtr("2")}},
